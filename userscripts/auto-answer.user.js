    ...
    shadow.innerHTML = `
      <style>
        ...
        *{box-sizing:border-box}.shell{position:relative}.fab,.panel{box-shadow:0 8px 24px rgba(15,23,42,.22)}
        ...
        .body{padding:6px}.actions{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:4px}.actions button{min-width:0;min-height:30px;border-radius:7px;padding:4px 2px;background:#e8eef8;color:#172033;font-size:11px;font-weight:680;white-space:nowrap}
